...
data_dir = '/home/data/pascal_voc/VOCdevkit/VOC2012/transfer'
...
torch.save(model_ft, 'VGG16_VOC_Model.pt')
######################################################################
#
...
## ^^^^^^^^^^^^^^^^^^
##
## On CPU this will take about halfpa the time compared to previous scenario.
